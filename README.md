...
TM Forum Open API (Apache 2.0) Revenue Sharing Report Management API.

Revenue Sharing Report Management API goal is to provide the report of a revenue sharing.
